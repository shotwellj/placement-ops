...
# Prompts extracted to a versioned module (2026-05-19) so they are
# inspectable, diffable, and trackable by version in the audit chain.
from api._prompts import (
    JD_PARSER,
    BOOLEAN_BUILDER,
    CANDIDATE_EVAL,
)
        ...
        async with db() as client:
            ...
            try:
                ...
                bool_mv_id = await register_model_version(
                    ...
                    prompt_text=BOOLEAN_BUILDER.body,
                    model_provider=provider,
                    model_name=provider,
                )
        ...
        async with db() as client:
            ...
            try:
                ...
                mv_id = await register_model_version(
                    ...
                    prompt_text=CANDIDATE_EVAL.body,
                    model_provider=provider,
